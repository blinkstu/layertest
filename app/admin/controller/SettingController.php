...
class SettingController extends AdminBaseController
{
    ...
    {
        $adminSettings  = cmf_get_option('lift_settings');
        $this->assign("lift_settings", $adminSettings);
    ...
    public function liftSettingPost(){
        ...
        $validate->message([
            'lift_distence'     => '电梯距离只能是500-10000之间',
            'lift_early.between' => '提前时间不能大于3天',
            'lift_late.between' => '迟到时间不能大于3天'
        ]);
